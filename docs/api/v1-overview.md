...
| `GET /api/v1/transactions` | Cursor-paginated normalized transactions with current provenance decision or legacy override + deterministic effective cash-flow classification (default window 730 days) |
